...
public class RobotBaboonsState_Run : EnemyState
{
    public   RobotBaboonsState_Run(string stateName)
    {
        statename = stateName;
        base.Init();
    }
    ...
    public override void LogicUpdate()
    {
        ...
        {
            stateMachine.SwitchState(typeof(RobotBaboonsState_Patrol));
            return;
        }
        ...
        {
            stateMachine.SwitchState(typeof(RobotBaboonsState_Attack));
            return;
        }
