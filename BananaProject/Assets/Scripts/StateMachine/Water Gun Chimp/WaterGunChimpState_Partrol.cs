...
public class WaterGunChimpState_Partrol : EnemyState
{
    public   WaterGunChimpState_Partrol(string stateName)
    {
        statename = stateName;
        base.Init();
    }
    ...
    public override void LogicUpdate()
    {
        ...
        if (stateduring>5f)
        {
            stateMachine.SwitchState(typeof(WaterGunChimpState_Attack));
